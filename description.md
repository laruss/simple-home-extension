...
This extension requires host permissions solely to fetch website metadata (page title and favicon) when users add bookmarks. No browsing data is collected, stored remotely, or shared. All data remains in Chrome's local/sync storage.
